...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (address router_, string memory name_, string memory symbol_, uint taxFee_, uint liquidityFee_) public {
        require(taxFee_ + liquidityFee_ < 100, 'Invalid fees');
